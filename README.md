...
It uses SAM2 (Segment Anything Model 2), a state-of-the-art Vision Transformer for zero-shot segmentation, and a dedicated algorithms to reconstruct cell files and extract anatomical traits along growth gradients.
